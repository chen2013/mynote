...
public class Lists
{
	...
	"create table if not exists lists (list_id text primary key , "
	...
	private static class DatabaseHelper extends SQLiteOpenHelper
	{
		...
		public void onCreate(SQLiteDatabase db)
		{
			...
			Log.v("create database lists success", "");
		}
	...
	//---向数据库中插入一个标题---
	public long insertItem(String list_id,String list_name, String list_created_time, int list_total,String list_class)
	{
	...
	//按list_id删除一个列表
	public boolean deleteItemById(String list_id)
	{
		return db.delete(DATABASE_TABLE, KEY_LISTID +
		"=" + list_id, null) > 0;
	}
	...
	{
		return db.query(DATABASE_TABLE, new String[] {KEY_LISTID,KEY_NAME,KEY_TIME,KEY_TOTAL,KEY_CLASS},
	...
	{
		Cursor mCursor =
		db.query(true, DATABASE_TABLE, new String[] {KEY_LISTID,KEY_NAME,KEY_TIME,KEY_TOTAL,KEY_CLASS},
		KEY_ROWID + "=" + rowId,
		null,null,null,null,null);
		if (mCursor != null) {
			mCursor.moveToFirst();
	...
	//---更新一个标题---
	public boolean updateItem(int rowId, String list_id,String list_name, String list_created_time, int list_total,String list_class)
	{
		ContentValues updateValues = new ContentValues();
		updateValues.put(KEY_LISTID, list_id);
